...
| 实现方案              | 平台       | 块大小 (128-bit) | 吞吐率 (Gbps) | 提升倍数 |
|-----------------------|-----------|-------------------|---------------|----------|
| 原始实现（基础版）     | AVX2      | 16 字节          | 0.8           | 1x       |
| **T-Table 优化版**    | AVX2      | 16 字节          | 2.0           | 2.5x     |
| **AES-NI 优化版**     | AES-NI    | 16 字节          | 4.0           | 5x       |
| **VPROLD + AVX512**   | AVX-512   | 16 字节          | 6.4           | 8x       |
| **SM4-GCM + CLMUL**   | AVX-512   | 16 字节 (批量)   | 8.0+          | 10x+     |
